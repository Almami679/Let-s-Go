...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        # Creando el Suelo
        # Esto loopea el sprite del suelo horizontalmente
        ...
        # Lista de todos los items que salen en pantalla
    ...
    def on_key_press(self, key, modifiers):   #detecta las teclas presionadas y el modificador
    ...
    def on_key_release(self, key, modifiers):   #cuando se deja de presionar la tecla
    ...
    def on_update(self, delta_time):   #esta funcion actaliza el juego
